...
export const SECTIONS: ContentSection[] = [
  {
    ...
    title: 'GUIDE YOUNG ADULTS TO FINANCIAL SUCCESS AND SUPPORT THEIR ENTREPRENEURIAL DREAMS TO REALITY',
...
export const FOOTER = {
  ...
  mission:   'We believe in guiding young adults toward financial independence and realizing their entrepreneurial dreams. Our mission is to provide the necessary support and resources to turn aspirations into reality, ensuring that every individual has the opportunity to lead a self-sufficient and fulfilling life.',
  social: [
  ...
  copyright: 'Copyright © 2026 Step2StepUp Inc., USA  |  For more information, write to us on  info@step2stepup.org',
};
...
export const founderProfile = {
  ...
  titles: ["Founder & CEO, Step2StepUp, Inc.",
...
export const galleryImages = [
  { src: "images/leadership/Priyanka-Chopra-300x200.webp", alt: "Priyanka Chopra" },
  { src: "images/leadership/Priyanka-Chopra-2-300x182.webp", alt: "Priyanka Chopra 2" },
...
export const paymentMethods = [
  {
    ...
    fields: [
      ...
      { label: "Memo Line", value: "Awards Night 2026, Attn: Vasu Pawar", highlight: true },
      {
        label: "Mail Address",
...
export const events: EventSection[] = [
{
    ...
    videoUrl: "https://www.youtube.com/embed/ZYIaXR4E_DI?start=497&autoplay=1&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3", 
  ...
  },
  {
    ...
    image:
      "images/events/powerful-logo-PNG.webp",
  ...
  },
  {
    ...
    image:
      "images/events/Life-Choices-AI.webp",
